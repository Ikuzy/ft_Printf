...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/10 21:02:52 by ozouine           #+#    #+#             */
/*   Updated: 2023/12/10 21:04:17 by ozouine          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int	handle_placeholder(const char *str, int *i,
	va_list varg, int *counter)
{
	if (str[*i + 1] == '%')
		*counter += write(1, "%", 1);
	else if (str[*i + 1] == 's')
